              ...
              <div className="flex flex-wrap gap-4 border-b border-[#F5A623]/20 pb-8">
                <div className="relative group flex-1 sm:flex-none">
                   <button 
                     ...
                     className={`w-full sm:w-auto flex items-center justify-center border-2 px-10 py-4 rounded-full transition-all font-semibold shadow-sm ${f.parsedDate ? 'bg-[#DF4832] border-[#DF4832] text-white hover:bg-[#F5A623] hover:border-[#F5A623]' : 'bg-gray-50 border-gray-100 text-gray-400 cursor-not-allowed'}`}
                   >
                   ...
                   {f.parsedDate && (
                       <div className="absolute top-full left-0 mt-2 w-full min-w-[220px] bg-white border border-gray-100 rounded-2xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 overflow-hidden">
                          <button onClick={() => handleGoogleCalendar(f)} className="w-full text-left px-6 py-4 text-sm font-medium text-[#2D2422] hover:bg-[#FFFCF8] hover:text-[#DF4832] transition-colors border-b border-gray-50">
                             Google Calendar
                          </button>
                          <button onClick={() => handleOutlookCalendar(f)} className="w-full text-left px-6 py-4 text-sm font-medium text-[#2D2422] hover:bg-[#FFFCF8] hover:text-[#DF4832] transition-colors">
                             Apple / Outlook (.ics)
                          </button>
                       </div>
                   )}
